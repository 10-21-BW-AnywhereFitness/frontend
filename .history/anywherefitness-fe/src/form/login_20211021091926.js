...
import { API_Call_loginService } from "../service/api_call";
import { setToken, setUserID, setWelcomeMessage } from "../constant/constant";
    ...
    API_Call_loginService(state)
      .then((res) => {
        ...
        if (res.data.role_id === 1) {
          history.push("/test/instructor");
        } else {
          history.push("/test/client");
        }
      })
      .catch((error) => {
