...
const ClientLanding = (props) => {
  ...
  const [clientReseredClasses, set_clientReseredClasses] = useState(null);
  ...
  useEffect(() => {
    ...
    api
      ...
      .then((res) => {
        ...
        set_clientReseredClasses(res.data);
      })
      .catch((error) => {
  ...
  return (
    <div className="client-landing">
      ...
      <p>There are {allAvailableClasses.length} classes available, please search them in <b>"Search Class"</b>.</p>
